...
#' @param approx bool; use the approximated but fast random projection based KNN graph implemented by largeVis
#' @param neighbormat NULL or matrix; can be used to provide a precalculated neighborhood matrix
#' 
...
#' 
#' @export
Rphenograph <- function(data, k=30, directed=FALSE, prune=FALSE, clust_fun=NULL, approx=F, neighbormat=NULL, ...){
    if(prune){
